...
export async function POST(request: Request) {
  try {
          ...
          <div class="container">
            ...
            <div class="content">
              ...
              <div class="info-row">
                ...
                <p style="margin-top: 5px; padding: 10px; background: white; border-radius: 6px;">${data.message}</p>
              </div>
              ` : ''}
        ...
        <body>
          <div class="container">
            ...
            <div class="content">
              ...
              <p>Thank you for requesting a quote from <strong>PlusPro Services</strong>! We've received your request and will review it carefully.</p>
              
              <div class="info-box">
                <p><strong>Service Requested:</strong> ${serviceName}</p>
                ${data.message ? `<p><strong>Your Details:</strong> ${data.message}</p>` : ''}
              </div>
              
              <p>Our team will review your project details and get back to you within 24-48 hours with a detailed quote.</p>
    ...
    await sendEmail({
      to: adminEmail,
      subject: `New Quote Request: ${data.name} - ${serviceName}`,
      html: adminEmailHtml,
    });

    await sendEmail({
      to: data.email,
      subject: "Quote Request Received - PlusPro Services",
